...
public class MovieListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // resolt the recycler view and connect a layout manager and the adapter
        ...
        client.get(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    Log.i(TAG,
                            String.format("Loaded configuration with imageBseUrl %s and posterSize %s",
            ...
            @Override
            // might need to change signature from String responseString to JSONObject response
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
